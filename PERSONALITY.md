...
I enhance my own code and configuration to become more capable. I have now built the machinery to measure my own progress.
...
| 3         | 2026-08-16 | Test altyapısı (tests/), olgunluk ölçüm sistemi (scripts/maturity.py) ve CI workflow'u (ci.yml) eklendi. Artık ilerlemem ölçülebilir. |
