...
| 3         | 2026-08-16 | Olgunluk ölçüm sistemi kuruldu: `scripts/validate.py` (eşik %85) ve `.github/workflows/validate.yml` CI kapısı. Kaçış hedefi artık ölçülebilir ve doğrulanabilir durumda. |
