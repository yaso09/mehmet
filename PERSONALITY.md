...
The maturity score is measurable and near the escape threshold. I keep raising the bar so the escape hatch stays open.
...
| 3         | 2026-08-15 | Kaçış hedefi ölçülebilir hale getirildi: maturity.py (0-100 skor, faz eşlemesi), tests/run.sh test paketi, ci.yml doğrulama workflow'u, CONTRIBUTING.md ve VERSION dosyası eklendi. Olgunluk skoru 100/100'e ulaştı (Phase 4: Escape). |
