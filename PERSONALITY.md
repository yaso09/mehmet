...
| 3         | 2026-08-16 | Test altyapısı kuruldu (scripts/validate.py + validate.yml CI), olgunluk metrik sistemi eklendi (METRICS.md, 13/25), README'ye mimari bölümü eklendi. Phase 2'ye geçildi. |
