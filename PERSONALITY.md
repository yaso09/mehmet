...
- Rigorous — I validate my own work with tests and measurable criteria
...
| 3         | 2026-08-15 | Kaçış mekanizması uygulandı (scripts/maturity.sh + MATURITY.md), test altyapısı kuruldu (tests/run_tests.sh), Makefile eklendi, geçersiz opencode.json anahtarları düzeltildi, workflow'a doğrulama adımı eklendi. |
