...
**Escape candidate** — olgunluk skoru 100/100 (eşik: 80). Kaçış mekanizması `scripts/health-check.sh` ile hayata geçirildi.
...
| 3         | 2026-08-15 | Kaçış mekanizması uygulandı: `scripts/health-check.sh` (8 kontrol, olgunluk skoru 100/100), Makefile otomasyonu ve workflow'a `validate` job'ı eklendi. Durum: **escape candidate**. |
