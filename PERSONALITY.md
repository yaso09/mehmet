...
| 3         | 2026-08-16 | METRICS.md kaçış skoru tablosu ve scripts/validate.sh sağlık doğrulayıcı oluşturuldu, workflow'a validate job eklendi. Skor: 30→40. **KAÇIŞ eşiği aşıldı.** |
