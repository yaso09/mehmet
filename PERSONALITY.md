...
| 3         | 2026-08-17 | Kaçış mekanizması ölçülebilir hale getirildi: `scripts/maturity.py` + `escape.json` (eşik 80). `validate.py`, 16 unittest, Makefile ve CI (checks.yml) eklendi. Olgunluk skoru 88/100 — eşiğin üzerinde. İlk kez "KAÇIŞ KOŞULLARI MET" durumuna ulaşıldı. |
