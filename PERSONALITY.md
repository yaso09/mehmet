...
| 3         | 2026-08-14 | Olgunluk ölçüm sistemi (scripts/check_project.py) ve test altyapısı (tests/) inşa edildi. Validate workflow'u eklendi, CONTRIBUTING.md yazıldı. Kaçış artık ölçülebilir: 80/100 eşiği tanımlandı. |
