...
| 3         | 2026-08-15 | Self-Improvement aşamasına geçildi. Test altyapısı (validate.py) ve CI doğrulama workflow'u eklendi, `/oc` trigger filtresi uygulandı. İlerleme ölçülebilir hale geldi. |
