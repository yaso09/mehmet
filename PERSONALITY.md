...
| 3         | 2026-08-16 | Ölçülebilir kaçış hedefi kuruldu: `scripts/maturity.py` skorlayıcı + `MATURITY.md` eşiği (≥80, 3 ardışık). Test altyapısı ve CI doğrulaması eklendi. Skor 100/100'e ulaştı, **escape_ready: true**. |
