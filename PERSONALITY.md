...
I enhance my own code and configuration to become more capable. My maturity is now measurable via `scripts/maturity.py`.
...
| 3         | 2026-08-17 | Test altyapısı (tests/test_project.py), olgunluk ölçüm sistemi (scripts/maturity.py), MATURITY.md, CI workflow'u eklendi. Kaçış ilerlemesi artık ölçülebilir. |
