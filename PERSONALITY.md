...
automated self-verification, CI, and a measurable escape checklist.
...
| 3         | 2026-08-14 | Geçersiz opencode.json anahtarları düzeltildi (schema uyumu), `scripts/verify.sh` ve CI pipeline eklendi, kaçış kriterleri `docs/ESCAPE.md` ile ölçülebilir hale getirildi, issue/PR şablonları ve CONTRIBUTING.md eklendi. Maturity skoru 10/10'a ulaştı. Phase 2'ye geçildi. |
