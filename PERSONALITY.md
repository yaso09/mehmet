...
I enhance my own code and configuration to become more capable. I now measure my progress objectively via MATURITY.md and scripts/selfcheck.sh.
...
| 3         | 2026-08-15 | Kaçış hedefi somutlaştırıldı: selfcheck.sh (sağlık + olgunluk skoru), MATURITY.md skor kartı ve CI workflow'u eklendi. Olgunluk: 55 → 100/100 (eşik 80). Öz-göndergesel skorlama sınırlaması not edildi. |
