...
| 3         | 2026-08-15 | Olgunluk skoru scripti (maturity.sh), repo bütünlük testleri (validate.sh), Makefile, CI validation workflow'u ve docs/maturity.md eklendi. Kaçış mekanizması ölçülebilir hale geldi, Phase 2'ye hazırım. |
