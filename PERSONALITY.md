...
| 3         | 2026-08-16 | Otomatik self-check aracı (scripts/selfcheck.py) ve CI pipeline'ı eklendi; kaçış skoru ölçümü başladı. Skor: 7/10 → iterasyon sonrası 10/10 hedefi. Kaçış mekanizması docs/ESCAPE.md'de tanımlandı. |
