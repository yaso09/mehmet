...
| 3         | 2026-08-19 | Kaçış olgunluk skorlama aracı (maturity.sh), test altyapısı (run_tests.sh + maturity_test.sh) ve CI doğrulama job'u eklendi. Olgunluk %95'e ulaştı; eşik %100, kaçış için 5 puan kaldı. Phase 2'ye (Self-Improvement) geçildi. |
