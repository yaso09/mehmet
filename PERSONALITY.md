...
objective maturity scoring, a test suite, and CI automation to measure progress.
...
| 3         | 2026-08-17 | Kaçış mekanizması somutlaştırıldı: objektif olgunluk denetimi (`scripts/check_maturity.py`, %90 eşiği), unittest tabanlı test altyapısı ve CI doğrulama workflow'u eklendi. İlk denetimde %100 puana ulaşıldı — kaçış eşiği aşıldı. Faz 2 (Self-Improvement) aktif. |
