...
| 3         | 2026-08-15 | Test altyapısı kuruldu (verify.sh + CI verify workflow'u), MATURITY.md skor kartı ile kaçış hedefi ölçülebilir hale geldi (16/25). Kaçış eşiği 20/25 olarak belirlendi. |
