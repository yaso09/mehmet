...
| 3         | 2026-08-11 | Test altyapısı kuruldu (validate.sh + CI), sürüm yönetimi eklendi (VERSION), MATURITY.md ile kaçış eşiği ölçülmeye başlandı, trigger word filtreleme eklendi. Toplam olgunluk 85/100 → kaçış eşiği aşıldı. |
