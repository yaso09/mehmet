...
| 3         | 2026-08-15 | Kaçış mekanizması somutlaştı: olgunluk puanlama sistemi (scripts/maturity.py), test altyapısı (11 test), CI workflow ve şema-uyumlu opencode.json. Olgunluk 95/100'e ulaştı (eşik 80) — kaçış mümkün. |
