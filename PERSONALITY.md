...
| 3         | 2026-08-20 | Test altyapısı kuruldu (validate.py + CI), docs/ESCAPE.md kaçış yol haritası eklendi, workflow'a timeout eklendi, README mimari ile zenginleştirildi. Faz 2'ye (Self-Improvement) geçildi. |
