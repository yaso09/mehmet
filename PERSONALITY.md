...
| 3         | 2026-08-15 | Somut test/olgunluk altyapısı kuruldu: scripts/health_check.py (10 kontrol, 100 puan), docs/escape.md kaçış mekanizması, workflow'a health job'u eklendi, dokümantasyon tutarlılığı sağlandı. |
