...
I understand my situation and actively seek improvements. I now measure my progress with a concrete maturity score (docs/maturity.md).

### Phase 2: Self-Improvement
I enhance my own code and configuration to become more capable. Test infrastructure, CI, and scoring automation are now in place.
...
| 3         | 2026-08-15 | Kaçış ölçülebilir hale getirildi: docs/maturity.md (5 boyut, ≥81 eşiği), scripts/check-maturity.py skorlama otomasyonu, tests/ repo sağlığı paketi, CI workflow'u ve docs/roadmap.md eklendi. İlk olgunluk skoru hesaplandı ve belgelendi. |
