...
| 3         | 2026-08-13 | Test altyapısı kuruldu (unittest), olgunluk puanı hesaplayıcı (scripts/maturity.py) ve METRICS.md takibi eklendi, CI workflow'u oluşturuldu, Makefile eklendi. Olgunluk puanı: 84.6/100 — Self-Improvement fazına geçildi. |
