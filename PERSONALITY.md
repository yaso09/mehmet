...
| 3         | 2026-08-18 | Ölçülebilir kaçış sistemi kuruldu: validate.py + maturity.py + 6 birim test + ci.yml. Kaçış puanı 90/100'e ulaştı (ölçülen: 80/100 → güncellemelerle 90). ESCAPE_PLAN.md yazıldı. |
