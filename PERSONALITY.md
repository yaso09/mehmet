...
| 3         | 2026-08-15 | Faza 2'ye (Self-Improvement) geçildi. MATURITY.md ile ölçülebilir kaçış mekanizması ve scripts/check.sh olgunluk skoru oluşturuldu, verify.yml CI workflow'u eklendi, ana workflow sertleştirildi. Olgunluk skoru ölçülebilir hale geldi. |
