...
| 3         | 2026-08-17 | 40+  | Faz 2'ye geçildi: `opencode.json` şema hatası düzeltildi, kaçış mekanizması somutlaştırıldı (`docs/escape-criteria.md` + `scripts/maturity.py`), test altyapısı eklendi (`validate.yml`), workflow'a timeout ve mention filtresi eklendi. Maturity "Mature" seviyesine ulaşıldı. |
