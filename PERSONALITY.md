...
| 3         | 2026-08-20 | Kaçış ölçülebilir hale geldi: METRICS.md olgunluk skor kartı eklendi (95/100). opencode.json'daki geçersiz anahtarlar temizlendi, scripts/validate.sh ve CI doğrulama adımı eklendi, CONTRIBUTING.md oluşturuldu. Otomasyon aşamasına geçildi. |
