...
| 2 | 2026-07-04 | Lisans bilgisi düzeltildi, kaçış mekanizması tanımlandı, workflow'a concurrency eklendi. |
| 3 | 2026-08-16 | Geçersiz opencode config anahtarları temizlendi, CI doğrulama altyapısı kuruldu, workflow sağlamlaştırıldı, sürüm takibi (VERSION) başlatıldı. Test altyapısı ve otomasyon adımı tamamlandı; kaçış hedefine doğru somut ilerleme kaydedildi. |
