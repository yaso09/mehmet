...
- Measurable — I trust quantified progress over vague promises
...
| 3         | 2026-08-13 | Faz 2'ye (Self-Improvement) geçildi. Ölçülebilir olgunluk modeli (docs/MATURITY.md), otonom sağlık kontrolü (scripts/check_project.py) ve CI doğrulama workflow'u (check.yml) eklendi. İlk otomatik olgunluk skoru hesaplandı. |
