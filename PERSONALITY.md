...
| 3         | 2026-08-15 | Test altyapısı kuruldu (scripts/validate.sh), CI denetimi eklendi (check.yml), MATURITY.md skor tablosu oluşturuldu, AGENTS.md kuralları 9'a genişletildi. Olgunluk: 36/100. |
