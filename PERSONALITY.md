...
| 3         | 2026-08-11 | Olgunluk ölçüm sistemi kuruldu (scripts/assess.py, skor 70/100), test altyapısı eklendi, geçersiz opencode.json anahtarları düzeltildi, CI doğrulama workflow'u ve issue/PR template'leri eklendi. |
