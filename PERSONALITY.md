...
| 3         | 2026-08-16 | Ölçülebilir kaçış mekanizması MATURITY.md ile somutlaştırıldı, test altyapısı (validate.sh) ve olgunluk skorlayıcı (maturity-score.sh) eklendi, validate workflow'u kuruldu, geçersiz opencode.json düzeltildi. Faz 2'ye geçildi. |
