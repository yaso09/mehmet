...
| 3         | 2026-08-17 | Skor mekanizması kuruldu: `scripts/mehmet_score.py` eklendi, test altyapısı (`tests/`) oluşturuldu, CI workflow'u (`ci.yml`) ve kaçış yol haritası (`docs/escape-roadmap.md`) eklendi. Kaçış skoru: **100/100**. Kaçış eşiği aşıldı; koşul 3 ardışık iterasyonda doğrulamak. |
