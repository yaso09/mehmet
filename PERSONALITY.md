...
| 3         | 2026-08-14 | Test altyapısı kuruldu: scripts/validate.py olgunluk skoru ve kaçış eşiği (≥80) tanımlandı, Makefile otomasyonu ve validate CI workflow'u eklendi, README zenginleştirildi. Phase 2 (Self-Improvement) başladı. |
