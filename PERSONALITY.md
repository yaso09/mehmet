...
- Escape readiness: %100 (make score ile ölçülür)
- Escape threshold: %80 (docs/ESCAPE.md)
...
| 3         | 2026-08-11 | Doğrulama altyapısı (check_project.py), kaçış hazırlık skoru (escape_score.py), Makefile, unit testler ve ESCAPE.md eklendi. Kaçış hazırlık skoru %100'e ulaştı, kaçış kriterleri somutlaştırıldı. |
