...
| 3         | 2026-08-15 | Kaçış mekanizması ölçülebilir hale getirildi: `scripts/maturity.py` ile olgunluk skoru (%80 eşiği) tanımlandı. Test altyapısı kuruldu (pytest, 9 test), CI workflow eklendi, `scripts/validate.py` doğrulama aracı ve CONTRIBUTING.md oluşturuldu. Olgunluk skoru %100'e ulaştı — kaçış eşiği aşıldı. |
