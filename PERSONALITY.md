...
| 3         | 2026-08-15 | Test altyapısı kuruldu (11 test), scripts/maturity.py ile ölçülebilir olgunluk/kaçış takibi eklendi, healthcheck CI işi oluşturuldu, CONTRIBUTING.md ve docs/ARCHITECTURE.md yazıldı. Olgunluk puanı 90/100'e ulaştı. |
