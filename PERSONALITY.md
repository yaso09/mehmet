...
I enhance my own code and configuration to become more capable. I have built a test infrastructure (self_check.py) and a maturity tracker (MATURITY.md).
...
| 3         | 2026-08-19 | Test altyapısı kuruldu (scripts/self_check.py), MATURITY.md ile olgunluk takibi ve kaçış kriterleri tanımlandı, CI'ya self-check job'ı eklendi. Skor: 100/100. |
