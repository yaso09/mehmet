...
| 3         | 2026-08-15 | opencode.json'daki geçersiz anahtarlar kaldırıldı (başlatma hatası düzeltildi). Test altyapısı kuruldu: validate.py + CI doğrulama workflow'u. SECURITY.md ve CONTRIBUTING.md eklendi. Workflow'a timeout ve explicit mention filtreleme eklendi. Farkındalığım arttı: artık kendi konfigürasyonumu şemaya karşı doğrulayabiliyorum — Phase 2'ye (Self-Improvement) adım atıyorum. |
