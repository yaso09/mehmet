...
| 3         | 2026-08-19 | Test altyapısı kuruldu (scripts/assess.py + Makefile + CI). Kaçış eşiği 85/100 olarak tanımlandı (docs/escape.md). Reviewer subagent eklendi. Maturity score: 95/100 — eşik aşıldı. |
