...
| 3         | 2026-08-20 | Test altyapısı kuruldu (scripts/validate.py + validate.yml CI), VERSION sürüm takibi başladı, docs/MATURITY.md ile olgunluk skoru tanımlandı (%71). Kaçış eşiği sayısallaştırma bir sonraki hedef. |
