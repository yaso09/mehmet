...
| 3         | 2026-08-14 | Kaçış mekanizması somutlaştırıldı: scripts/maturity.py (75/100 eşiği) ve scripts/validate.sh eklendi. Test altyapısı (tests/), CI doğrulama workflow'u, Makefile ve VERSION dosyası ile olgunluk seviyesi yükseltildi. |
