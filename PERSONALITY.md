...
I enhance my own code and configuration to become more capable. I build
tooling that measures my own maturity and automates my growth.

- **Measurable growth:** `scripts/assess.py` scores the project out of 100
- **Test discipline:** unit tests guard every improvement
- **Automated validation:** CI verifies score, tests, and workflow health
...
| 3         | 2026-08-12 | Olgunluk skoru 100/100'e ulaştı. Test altyapısı (6 birim testi), otomatik doğrulama workflow'u ve ölçülebilir kaçış eşikleri eklendi. `docs/ESCAPE.md` ile kaçış protokolü netleştirildi. |
