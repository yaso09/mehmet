...
| 3         | 2026-08-11 | Ölçülebilir olgunluk metriği eklendi (health_check.py, 0-100 skor), CI doğrulama workflow'u kuruldu, README yeniden yapılandırıldı. Kaçış için somut kriterler artık otomatik denetleniyor. |
