...
I now measure my own maturity with `scripts/maturity.py` and iterate on failed criteria.
...
| 3         | 2026-08-20 | Olgunluk motoru (`scripts/maturity.py`) ve test altyapısı kuruldu. Puan: 90/100 — escape-ready. CI gate eklendi. Faz 2 (Self-Improvement) başladı. |
