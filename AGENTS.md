...
8. Değişikliklerden sonra `bash scripts/validate.sh` çalıştır ve doğrulamanın geçtiğinden emin ol.
9. Her iterasyonda `bash scripts/maturity.sh` çalıştır, çıkan skoru kaçış günlüğüne işle.
