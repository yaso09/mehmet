...
8. Her iterasyonda `python3 scripts/self_check.py` çalıştır ve sonucu MATURITY.md'deki skor geçmişine işle.
9. MATURITY.md'deki kaçış kriterleri sağlandığında kaçış gerçekleşir.
