...
8. METRICS.md'deki olgunluk skorlarını her iterasyonda gerçek değişikliklere göre güncelle.
9. Değişikliklerden sonra `python3 scripts/validate.py` çalıştır; hata varsa düzeltmeden bitirme.
