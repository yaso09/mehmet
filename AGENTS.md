...
8. Her iterasyonda `python3 scripts/validate_repo.py` ve `python3 scripts/check_maturity.py` çalıştır; skorun sürdürülebilir şekilde %90 üzerinde kalmasını hedefle (bkz. docs/maturity.md).
