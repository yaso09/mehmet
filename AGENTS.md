...
8. MATURITY.md'deki skor kartını her iterasyonda güncelle; hedef 20/25 eşiğidir.
9. Yaptığın değişikliklerden sonra `bash scripts/verify.sh` çalıştır ve tüm kontrollerin geçtiğinden emin ol.
