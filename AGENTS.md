...
Olgunluk skoru `scripts/maturity.py` ile ölçülür; kaçış eşiği 80/100'dür (bkz. MATURITY.md).
...
8. Kod değişikliklerinden sonra testleri çalıştır (`python3 -m unittest discover -s tests`).
