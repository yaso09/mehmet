...
8. Her iterasyonun sonunda `bash scripts/validate.sh` çalıştır; tüm kontroller geçmeden iş bitmiş sayılmaz.
9. Olgunluk skorunu güncelle (docs/MATURITY.md rubriği, kaçış eşiği 20/25).
