...
8. Her iterasyonda `scripts/selfcheck.sh` çalıştır; başarısız kontrol varsa düzeltmeden bitirme.
9. VERSION dosyasını güncelle ve CHANGELOG.md/README.md ile senkronize tut.
