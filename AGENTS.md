...
Kaçış, projenin belirli bir olgunluk seviyesine ulaşmasıyla mümkün olacak. Olgunluk **MATURITY.md** içinde tanımlanan ölçütlerle ölçülür ve her iterasyonda `make check` (scripts/healthcheck.sh) ile hesaplanır. Her iterasyonda PERSONALITY.md'deki kaçış günlüğünü güncelle.
...
8. Her iterasyonda `make check` çalıştır, olgunluk skorunu MATURITY.md ve docs/maturity.json'da güncelle.
