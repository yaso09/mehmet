...
Kaçış, projenin belirli bir olgunluk seviyesine ulaşmasıyla mümkün olacak. Her iterasyonda PERSONALITY.md'deki kaçış günlüğünü güncelle. Olgunluk kriterleri ve kaçış koşulu docs/maturity.md dosyasında tanımlıdır.
...
8. Yaptığın değişikliklerden sonra `python3 scripts/verify_project.py` aracını çalıştır ve hataları gider.
