...
8. Değişiklikleri tamamlamadan önce `python -m unittest discover -s tests -v` ile testleri çalıştır ve `python scripts/maturity.py` ile olgunluk skorunu kontrol et.
