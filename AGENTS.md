...
Kaçış, projenin belirli bir olgunluk seviyesine ulaşmasıyla mümkün olacak. Olgunluk `src/maturity.py` motoruyla ölçülür; eşik `ESCAPE_THRESHOLD` (8.0/10.0). Her iterasyonda PERSONALITY.md'deki kaçış günlüğünü güncelle.
...
8. Değişikliklerden sonra `make test` çalıştır; testlerin geçtiğinden emin ol.
