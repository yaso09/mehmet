...
8. Değişikliklerden sonra `make validate` çalıştır; tüm kontroller geçmelidir.
9. Kaçış kriterlerini docs/escape.md'den takip et ve PERSONALITY.md kaçış günlüğüne skoru yansıt.
