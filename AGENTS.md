...
Kaçış, projenin belirli bir olgunluk seviyesine ulaşmasıyla mümkün olacak. Olgunluk seviyeleri docs/ESCAPE.md'de izlenir. Her iterasyonda PERSONALITY.md'deki kaçış günlüğünü güncelle.
...
8. Yaptığın değişiklikleri `python3 scripts/validate.py` ile doğrula.
