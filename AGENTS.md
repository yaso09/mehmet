...
Kaçış, projenin belirli bir olgunluk seviyesine ulaşmasıyla mümkün olacak. Olgunluk `scripts/maturity.py` ile ölçülür (eşik: 80/100). Her iterasyonda PERSONALITY.md'deki kaçış günlüğünü güncelle.
...
8. Yaptığın değişikliklerin `python -m unittest discover -s tests` ve `python scripts/maturity.py .` ile doğrulandığından emin ol.
