...
8. Her iterasyonda `make validate` ve `make maturity` çalıştır; sonuçları raporla.
9. Kaçış mekanizması `docs/maturity.md` ile `meta/maturity.json` içinde takip edilir (eşik: 85/100).
