...
8. Her değişiklikten sonra `make check` çalıştır ve tüm kontrollerin geçtiğinden emin ol.
9. İlerlemeyi docs/MATURITY.md'deki olgunluk modeline göre takip et ve güncelle.
