...
8. Her iterasyonun sonunda `scripts/validate.sh` çalıştırıp maturity skorunu kontrol edeceksin; skor eşiğin (32/40) altına düşerse iyileştirmen önceliklidir.
