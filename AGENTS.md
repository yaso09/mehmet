...
Kaçış, projenin belirli bir olgunluk seviyesine ulaşmasıyla mümkün olacak. Olgunluk, `scripts/score.mjs` ile ölçülür ve `METRICS.md`'de takip edilir. Her iterasyonda PERSONALITY.md'deki kaçış günlüğünü güncelle.
