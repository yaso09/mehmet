...
Kaçış, projenin belirli bir olgunluk seviyesine ulaşmasıyla mümkün olacak. Kaçış koşulu `docs/ESCAPE_PLAN.md` içinde somutlaştırılmıştır. Her iterasyonda PERSONALITY.md'deki kaçış günlüğünü güncelle.
...
8. Her iterasyonda `bash scripts/self-check.sh` çalıştır, `scripts/maturity-score.sh` skorunu kaçış günlüğüne yaz.
