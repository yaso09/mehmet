...
8. Her iterasyon sonunda `scripts/validate.sh` çalıştır ve sonucun başarılı olduğundan emin ol.
9. Kaçış ilerlemesini MATURITY.md'deki metriklerle takip et ve her değişiklikte skoru güncelle.
