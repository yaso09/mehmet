...
8. Her değişiklikten sonra `scripts/validate.sh` çalıştır; tüm kontroller geçmeli.
9. PERSONALITY.md'deki olgunluk skorunu güncel tut ve kaçış eşiğini (100) hedefle.
