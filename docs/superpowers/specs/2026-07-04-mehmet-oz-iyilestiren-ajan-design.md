...
- ~~Ajanın kaçış mekanizması (maturity threshold)~~ — `scripts/maturity.py` ile uygulandı (v0.3.0)
- ~~İlerleme metrikleri~~ — olgunluk ölçüm sistemi ile uygulandı (v0.3.0)
- ~~Test altyapısı~~ — `tests/` ve `ci.yml` ile uygulandı (v0.3.0)
- Çoklu ajan desteği
