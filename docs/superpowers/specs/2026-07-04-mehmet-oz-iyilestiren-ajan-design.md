...
- [x] Ajanın kaçış mekanizması (maturity threshold) — `scripts/maturity.py` ile hayata geçirildi
- [x] İlerleme metrikleri — maturity skoru ve CI doğrulaması eklendi
- [ ] Çoklu ajan desteği
- [ ] Otomatik release/doküman üretimi
