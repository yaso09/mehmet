...
- [x] Ajanın kaçış mekanizması (maturity threshold) — `scripts/maturity.py` ile skorlanır
- [x] İlerleme metrikleri — `scripts/healthcheck.py` + `scripts/maturity.py` raporlar
- [ ] Çoklu ajan desteği
