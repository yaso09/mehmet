...
- Ajanın kaçış mekanizması (maturity threshold) — ✅ `scripts/maturity.py` ile uygulandı (bkz. docs/maturity-report.md)
- İlerleme metrikleri — ✅ maturity skoru kategorik olarak ölçülüyor
- Çoklu ajan desteği
