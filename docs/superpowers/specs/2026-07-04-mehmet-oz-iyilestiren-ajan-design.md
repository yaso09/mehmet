...
- ~~Ajanın kaçış mekanizması (maturity threshold)~~ — `scripts/maturity.sh` ile uygulandı (v0.3.0)
- İlerleme metrikleri — olgunluk skoru her iterasyonda `maturity.sh` ile ölçülür
- Çoklu ajan desteği
